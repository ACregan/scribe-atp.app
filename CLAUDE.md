...
| Code / Link   | Inline code `</>`, Link 🔗 (shows URL input inline when inserting), Image 🖼 (opens `ImagePickerModal` to browse the Image Library and insert at cursor) |
